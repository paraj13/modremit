                        ...
                        <div class="col-md-7">
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                                <div class="card-header bg-white py-3 border-bottom-0">
                                    <h5 class="mb-0 fw-bold border-start border-4 ps-3 border-accent-lime">Transfer Summary</h5>
                                </div>
                                    ...
                                    <div class="bg-light rounded-4 p-4">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-2 text-center py-2 py-md-0">
                                                <div class="track-arrow-icon bg-white rounded-circle d-inline-flex align-items-center justify-content-center shadow-sm">
                                            ...
                                            <div class="col-12 col-md-5 text-md-end">
                                                ...
                                                <div class="h3 fw-bold text-brand-dark mb-0">
                            ...
                            <div class="card border-0 shadow-sm rounded-4 bg-brand-dark text-white p-4">
                                <div class="d-flex align-items-center">
                                    <div class="bg-brand-mint rounded-circle me-4 icon-circle-lg">
