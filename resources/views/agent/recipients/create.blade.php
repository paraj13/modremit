    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-5">
            ...
            <div class="card-body p-5">
                <form action="{{ isset($recipient) ? route('agent.recipients.update', $recipient->id) : route('agent.recipients.store') }}" method="POST" id="recipientCreateForm">
                    @csrf
...
$(document).ready(function() {
    window.initGlobalValidation('recipientCreateForm', {
