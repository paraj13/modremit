    ...
    <div class="col-md-7">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white py-4 border-0 text-center">
                <h4 class="fw-bold mb-0">Update Beneficiary</h4>
                <p class="text-muted small mb-0">Modify details for <span class="text-primary fw-bold">{{ $recipient->name }}</span></p>
            </div>
                ...
                <form action="{{ route('agent.recipients.update', $recipient->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control bg-light border-0 shadow-none @error('name') is-invalid @enderror" value="{{ old('name', $recipient->name) }}" placeholder="Receiver Name" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="bank_name" class="form-control bg-light border-0 shadow-none @error('bank_name') is-invalid @enderror" value="{{ old('bank_name', $recipient->bank_name) }}" placeholder="State Bank of India" required>
                            </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="account_number" class="form-control bg-light border-0 shadow-none @error('account_number') is-invalid @enderror" value="{{ old('account_number', $recipient->account_number) }}" placeholder="00000000000" required>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="ifsc_code" class="form-control bg-light border-0 shadow-none @error('ifsc_code') is-invalid @enderror" value="{{ old('ifsc_code', $recipient->ifsc_code) }}" placeholder="SBIN0001234">
                            </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="upi_id" class="form-control bg-light border-0 shadow-none @error('upi_id') is-invalid @enderror" value="{{ old('upi_id', $recipient->upi_id) }}" placeholder="username@upi">
                            </div>
                    ...
                    <div class="d-grid gap-2 pt-2">
                        <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow-sm">
                             <i class="bi bi-check-circle-fill me-2"></i> Update Recipient
                        </button>
                        <a href="{{ route('agent.customers.show', $recipient->customer_id) }}" class="btn btn-light rounded-pill py-2">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
