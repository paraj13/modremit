                ...
                <table class="table table-hover align-middle table-premium mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fi fi-{{ strtolower($r->country_code ?? 'un') }} me-1"></span>
                                <span class="small">{{ $r->country }}</span>
                            </td>
                            <td class="text-center pe-3">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('customer.transfers.create', ['recipient_id' => $r->id]) }}" class="btn btn-sm btn-brand rounded-pill px-3">Send Money</a>
                                    <a href="{{ route('customer.recipients.show', $r->id) }}" class="btn btn-sm btn-brand-outline rounded-pill px-3">View</a>
                                </div>
                            </td>
                        </tr>
                        @empty
